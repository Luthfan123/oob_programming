...
class StringMan
{
 ...
 System.out.println("\n***DATA CONVERSION***");
 System.out.println(" Data conversion using valueOf(): "+String.valueOf(s1));

 System.out.println("Conversion using toString: " +s2.toString());
...
***DATA CONVERSION***
 Data conversion using valueOf(): STRING
Conversion using toString: PROGRAM
